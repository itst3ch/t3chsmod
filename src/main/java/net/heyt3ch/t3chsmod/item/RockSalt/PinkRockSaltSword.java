...
public class PinkRockSaltSword extends SwordItem
{
    public PinkRockSaltSword(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
    ...
    public boolean postHit(net.minecraft.item.ItemStack stack, net.minecraft.entity.LivingEntity target, net.minecraft.entity.LivingEntity attacker)
    {
        ...
        if (stack.getItem() instanceof PinkRockSaltSword)
        {
